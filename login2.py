# -*- coding: utf-8 -*-
"""
Created on Fri Aug  6 14:11:16 2021
...
class LoginView():
    ...
    def initializeUI(self):
        ...
        tk.Label(self.window, text="登录助手",font=ft, bg=background_color).place(x=130,y=50)
    ...
    def usr_sign_up(self):
        ...
        def usr():
            window_usr_up = tk.Toplevel(window_sign_up)
            window_usr_up.geometry('350x200')
            tku.center_window(window_usr_up)
            window_usr_up.title('changshi')
        # 新建注册界面
        #ft = tkFont.Font(family='Fixdsys', size=16, weight=tkFont.BOLD)
        ...
        bt=tk.Button(window_sign_up, text='尝试', fg="#FFA500",command=usr)
