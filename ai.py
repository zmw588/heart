# -*- coding: utf-8 -*-
"""
Created on Sat Aug  7 15:02:13 2021
...
class Window():
	...
	def main_right(self, parent):
		...
		tk.Button(f4, text="开始一级诊断", width=12, command=zhenduan).pack(side=tk.LEFT,padx=5)
		#label(f4, space(5) + "*", fg="red").pack(side=tk.LEFT, anchor=tk.N, pady=5)
		#label(f4, space(8) +"一级诊断:").pack(side=tk.LEFT, anchor=tk.N, pady=5)
		tk.Text(f4, bg="white", font=_ft(10), height=5, width=60).pack(side=tk.LEFT, padx=20, pady=5)
		f4.pack(fill=tk.X)
        
		f5 = tk.Frame(frame, bg="white")
		tk.Button(f5, text="进行二级诊断", width=12, command=zhenduan).pack(side=tk.LEFT, padx=5, pady=5)
		#label(f4, space(5) + "*", fg="red").pack(side=tk.LEFT, anchor=tk.N, pady=5)
		...
		tk.Button(f6, text="进行三级诊断", width=12, command=zhenduan).pack(side=tk.LEFT, padx=5, pady=5)
		#label(f4, space(5) + "*", fg="red").pack(side=tk.LEFT, anchor=tk.N, pady=5)
